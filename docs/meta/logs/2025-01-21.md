# Documentation Formatting and Rules Enhancement (January 22, 2025)

_Last Updated: 03:21 CST_
...
- Updated cover images for better visibility
...
### Table Formatting
- Fixed table formatting in character classes documentation
- Updated to Python-Markdown compatible syntax
...
#Documentation #MkDocs #MaterialTheme #GameDev #CulturalGaming #EdgeAI #BuildInPublic #RaspberryPi #AIGaming
