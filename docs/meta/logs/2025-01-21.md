...
1. Added comprehensive requirements documentation:
   - Global dependencies for all scripts
   - Specific dependencies for each script category
   - Installation instructions with version requirements
   - Operating system compatibility information

2. Enhanced image management system:
   - Added image resizing (max width 800px, maintain aspect ratio)
   - Set web-optimized DPI (72)
   - Improved JPEG quality settings (95%, optimized)
   - Added size and DPI validation

3. Improved documentation organization:
   - Added admonitions for better visibility
   - Enhanced script categories documentation
   - Simplified root README with better references
   - Added metadata fields to script documentation

### Files Modified

1. Script Documentation:
   - `docs/scripts/README.md`: Added requirements and reorganized content
   - `docs/scripts/image_management/README.md`: Added requirements and image processing details
   - `docs/scripts/doc_validation/README.md`: Added requirements section
   - `docs/scripts/log_management/README.md`: Added requirements section

2. Scripts:
   - `docs/scripts/image_management/scrub_metadata.py`: Added image optimization features

3. Other:
   - `README.md`: Simplified and improved documentation references

## Impact

- Better documentation maintainability through clear requirements
- Enhanced image optimization for web use
- Improved privacy protection for AI-generated images
